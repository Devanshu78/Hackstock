...
import { warmUpCache, schedulePeriodicCacheWarming } from "./src/utils/cacheWarming.js";
...
connectDB()
  .then(async () => {
    ...
    server.listen(PORT, "0.0.0.0", async () => {
      ...
      console.log(`   - Network (WiFi): http://192.168.1.5:${PORT}`);
      console.log(`   - Network (LAN):  http://192.168.56.1:${PORT}`);
      console.log(`\n🌐 CORS: Local network access enabled for testing`);
      console.log(`${"=".repeat(60)}\n`);
    });
  })
