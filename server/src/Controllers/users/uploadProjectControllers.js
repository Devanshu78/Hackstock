...
import { invalidateCache, invalidateMultiplePatterns } from "../../middleware/cacheMiddleware.js";
import { CACHE_PATTERNS } from "../../utils/cacheKeys.js";
  ...
  Promise.all(uploads)
    .then(async (images) => {
      ...
      await invalidateMultiplePatterns([
        CACHE_PATTERNS.ALL_PROJECTS,
        CACHE_PATTERNS.USER_SPECIFIC(userId),
        `*teacher:${teachId._id}*`,
      ]);
...
export const deleteProject = async (req, res) => {
  ...
  try {
    ...
    await invalidateMultiplePatterns([
      CACHE_PATTERNS.ALL_PROJECTS,
      CACHE_PATTERNS.PROJECT_SPECIFIC(id),
      CACHE_PATTERNS.USER_SPECIFIC(project.userId),
